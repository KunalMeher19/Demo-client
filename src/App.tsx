...
function App() {
  ...
  return (
    <div className="min-h-screen w-screen overflow-x-hidden bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-sans transition-colors duration-300">
      <button
